...
const _excluded = ["as", "children", "id", "id_aliases", "pluginProps", "slotOptions", "slotErrorFallbackComponent"];
...
function BasePluginSlot(_ref, ref) {
  let {
  ...
  */
  ...
  const {
    keepDefault,
    plugins
  } = (0, _hooks.usePluginSlot)(id, id_aliases);
  const {
    formatMessage
  } = (0, _i18n.useIntl)();
...
BasePluginSlot.propTypes = {
  ...
  id_aliases: _propTypes.default.arrayOf(_propTypes.default.string),
...
const PluginSlot = /*#__PURE__*/(0, _react.forwardRef)(BasePluginSlot);
